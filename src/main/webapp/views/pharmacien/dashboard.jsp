...
<html>
<head>
    <title>Dashboard Pharmacien - PHARMACIE MOUHAMED</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                <div class="text-center py-4">
                    ...
                    <small class="text-white-50">Espace Pharmacien</small>
                </div>
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="#">
                        <i class="fas fa-pills me-2"></i> Gestion Stock
                    </a>
                    <a class="nav-link" href="#">
                        <i class="fas fa-plus-circle me-2"></i> Ajouter Médicament
                    </a>
                    <a class="nav-link" href="#">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h2 class="mb-0">Dashboard Pharmacien</h2>
                    ...
                    <div class="col-md-4">
                        <div class="quick-actions">
                            ...
                            <a href="#" class="action-btn">
                                ...
                                <div>
                                    <div class="fw-bold">Ajouter Médicament</div>
                                    <small class="text-muted">Nouveau produit</small>
                                </div>
                            </a>
                            <a href="#" class="action-btn">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Vendre des médicaments</small>
                                </div>
                            </a>
                            <a href="#" class="action-btn">
                                <i class="fas fa-boxes"></i>
                                <div>
                                    <div class="fw-bold">Gérer Stock</div>
                                    <small class="text-muted">Ajuster les quantités</small>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="stats-card">
                                    ...
                                    <div class="stats-label">Total Médicaments</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="stats-card">
                                    ...
                                    <div class="stats-number"><%= dashboardData.get("medicamentsDisponibles") %></div>
                            ...
                            <div class="col-md-4">
                                <div class="stats-card">
                                    ...
                                    <div class="stats-number"><%= dashboardData.get("ventesAujourdhui") %></div>
                        ...
                        <div class="alert-card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <% 
                                        List<Medicament> stockFaible = (List<Medicament>) dashboardData.get("alertesStock");
                        ...
                        <div class="alert-card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <% 
                                        List<Medicament> expiration = (List<Medicament>) dashboardData.get("alertesExpiration");
